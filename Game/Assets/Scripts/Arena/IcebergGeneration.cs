...
public class IcebergGeneration : MonoBehaviour
{
    ...
    void setIceBlock()
    {
        (Instantiate(Resources.Load("Prefabs/DishOfWater") as GameObject, new Vector3(rows/2f, 0f, columns/2f), Quaternion.identity) as GameObject).transform.SetParent(boardHolder);
        boardHolder = new GameObject("Board").transform;
